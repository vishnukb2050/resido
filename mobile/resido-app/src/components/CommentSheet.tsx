    ...
    return (
        <View style={styles.overlay}>
            ...
            <RNAnimated.View style={[styles.sheet, { transform: [{ translateY }] }]}>
                ...
                {loading ? (
                    <ActivityIndicator style={{ marginTop: 50 }} color="#4c1d95" />
                ) : (
                    <FlatList
                        data={comments}
...
const styles = StyleSheet.create({
    ...
    pollOptionSelected: { borderColor: '#4c1d95', backgroundColor: 'rgba(99, 102, 241, 0.1)' },
    ...
    pollPercentage: { fontSize: 11, fontWeight: '800', color: '#4c1d95', zIndex: 1 },
