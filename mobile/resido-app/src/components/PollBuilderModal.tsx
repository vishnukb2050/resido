...
const styles = StyleSheet.create({
    ...
    publishBtn: { backgroundColor: '#0d9488', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 12 },
    ...
    addOptionText: { fontSize: 14, fontWeight: '700', color: '#0d9488', marginLeft: 8 },
    ...
    durationBtnActive: { backgroundColor: '#f5f3ff', borderColor: '#0d9488' },
    durationText: { fontSize: 14, fontWeight: '700', color: '#64748b' },
    durationTextActive: { color: '#0d9488' },
});
