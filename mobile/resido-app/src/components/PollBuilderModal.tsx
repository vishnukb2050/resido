...
const styles = StyleSheet.create({
    ...
    publishBtn: { backgroundColor: '#6366f1', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 12 },
    ...
    addOptionText: { fontSize: 14, fontWeight: '700', color: '#6366f1', marginLeft: 8 },
    ...
    durationBtnActive: { backgroundColor: '#f5f3ff', borderColor: '#6366f1' },
