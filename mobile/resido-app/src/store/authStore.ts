...
interface AuthState {
    ...
    user: { id: string; name?: string; username?: string; email?: string; profileName?: string; phoneVisibility?: string; phone: string; profilePhoto?: string; role?: string; age?: number; description?: string; location?: string } | null;
