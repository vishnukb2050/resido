...
const styles = StyleSheet.create({
    ...
    uploadArea: { height: 100, borderRadius: 16, borderStyle: 'dashed', borderWidth: 1, borderColor: '#6366f1', backgroundColor: 'rgba(99, 102, 241, 0.05)', alignItems: 'center', justifyContent: 'center', gap: 8 },
