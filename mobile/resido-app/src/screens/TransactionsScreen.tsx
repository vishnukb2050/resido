...
const TRANSACTIONS = [
    ...
    { id: '2', title: 'Freelance Project', category: 'Income', amount: 3750, date: 'May 11, 2025', type: 'INCOME', icon: 'laptop-code', color: '#6366f1' },
...
const styles = StyleSheet.create({
    ...
    monthTitle: { fontSize: 14, fontWeight: '800', color: '#6366f1', textTransform: 'uppercase', marginBottom: 16 },
