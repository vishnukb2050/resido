...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 24, fontWeight: '800', color: '#5B4B8A', marginTop: 40, marginBottom: 24 },
    group: { marginBottom: 18 },
    label: { color: '#9A8EBA', fontSize: 12, fontWeight: '600', textTransform: 'uppercase', marginBottom: 8 },
    input: { backgroundColor: '#ffffff', borderRadius: 10, padding: 14, color: '#5B4B8A', fontSize: 15, borderWidth: 1, borderColor: '#D4C9E8' },
    chip: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: '#ffffff', borderWidth: 1, borderColor: '#D4C9E8' },
    chipActive: { backgroundColor: 'rgba(37,99,235,0.2)', borderColor: '#8b5cf6' },
    chipText: { color: '#9A8EBA', fontSize: 12, fontWeight: '600' },
    chipTextActive: { color: '#8b5cf6' },
    photoBtn: { backgroundColor: '#ffffff', borderRadius: 12, borderWidth: 1, borderColor: '#D4C9E8', borderStyle: 'dashed', height: 52, alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
    photoBtnText: { color: '#7A6B9C', fontWeight: '600' },
    thumb: { width: 80, height: 80, borderRadius: 8 },
    submitBtn: { backgroundColor: '#8b5cf6', borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 8 },
    submitText: { color: '#2D2445', fontWeight: '700', fontSize: 16 },
});
