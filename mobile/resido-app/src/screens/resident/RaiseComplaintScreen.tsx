...
const styles = StyleSheet.create({
    ...
    chipActive: { backgroundColor: 'rgba(99,102,241,0.2)', borderColor: '#0d9488' },
    ...
    submitBtn: { backgroundColor: '#0d9488', borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 8 },
