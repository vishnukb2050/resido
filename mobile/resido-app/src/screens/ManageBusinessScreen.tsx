    ...
    const renderEmptyState = () => (
        <View style={styles.emptyContainer}>
            <View style={styles.emptyIconBox}>
                <MaterialCommunityIcons name="storefront-outline" size={80} color="#6366f1" />
            </View>
...
const styles = StyleSheet.create({
    ...
    createBtn: { width: '100%', height: 60, borderRadius: 20, backgroundColor: '#6366f1', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', shadowColor: '#6366f1', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.3, shadowRadius: 16, elevation: 8 },
    ...
    addText: { fontSize: 16, fontWeight: '700', color: '#6366f1' }
});
