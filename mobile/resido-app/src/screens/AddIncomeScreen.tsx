                ...
                <View style={styles.formCard}>
                    <View style={styles.inputGroup}>
                        ...
                        <View style={styles.inputWrapper}>
                            <FontAwesome5 name="wallet" size={16} color="#6366f1" style={styles.inputIcon} />
                            <TextInput 
                                style={styles.input}
...
const styles = StyleSheet.create({
    ...
    saveBtn: { backgroundColor: '#6366f1', height: 60, borderRadius: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 32, gap: 10, shadowColor: '#6366f1', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.3, shadowRadius: 16, elevation: 8 },
