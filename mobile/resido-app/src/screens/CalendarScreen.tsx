...
const styles = StyleSheet.create({
    ...
    viewToggleButtonActive: { backgroundColor: '#0d9488' },
    ...
    dateCellActive: { backgroundColor: '#f5f3ff', borderRadius: 12, borderWidth: 1, borderColor: '#0d9488' },
    dateNumber: { fontSize: 14, fontWeight: '700', color: '#1e293b' },
    dateNumberActive: { color: '#0d9488' },
    dotsContainer: { flexDirection: 'row', gap: 2, marginTop: 2 },
    dot: { width: 4, height: 4, borderRadius: 2 },
    dateLabel: { position: 'absolute', bottom: 4, backgroundColor: '#0d9488', paddingHorizontal: 4, paddingVertical: 1, borderRadius: 4 },
    ...
    eventsCount: { fontSize: 12, fontWeight: '700', color: '#0d9488' },
    ...
    viewFullDayText: { fontSize: 14, fontWeight: '800', color: '#0d9488' },

    fab: { position: 'absolute', bottom: 100, right: 20, width: 64, height: 64, borderRadius: 32, backgroundColor: '#0d9488', alignItems: 'center', justifyContent: 'center', shadowColor: '#0d9488', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.3, shadowRadius: 15, elevation: 10 },
});
