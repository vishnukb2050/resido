...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, SafeAreaView, ActivityIndicator, Image, Linking } from 'react-native';
...
export default function StaffContactsScreen() {
    ...
    const fetchStaff = async () => {
        try {
            ...
            const res = await axios.get(`http://localhost:3002/members?role=STAFF_GROUP`, {
...
const styles = StyleSheet.create({
    ...
    staffCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.03)', padding: 18, borderRadius: 24, marginBottom: 15, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
