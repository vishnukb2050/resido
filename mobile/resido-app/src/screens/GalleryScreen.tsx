        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            {loading && folders.length === 0 ? (
                    ...
                    renderItem={({ item }) => (
                        <TouchableOpacity style={styles.folderCard} onPress={() => openFolder(item)}>
                            <View style={styles.folderThumb}>
                                <Ionicons name="folder" size={60} color="#1d4ed8" />
                ...
                <FlatList
                    ...
                    ListEmptyComponent={loading ? <ActivityIndicator color="#1d4ed8" /> : <Text style={styles.empty}>No media in this folder</Text>}
                />
            )}
...
const styles = StyleSheet.create({
    ...
    subTitle: { fontSize: 12, color: '#1d4ed8', fontWeight: '800', marginTop: 2 },
    actionBtn: { backgroundColor: '#1d4ed8', width: 44, height: 44, borderRadius: 14, alignItems: 'center', justifyContent: 'center', shadowColor: '#1d4ed8', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 4 },
    ...
    itemCount: { fontSize: 12, fontWeight: '900', color: '#1d4ed8' },
