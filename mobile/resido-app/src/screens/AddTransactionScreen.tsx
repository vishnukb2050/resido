...
const styles = StyleSheet.create({
    ...
    uploadBtnText: { color: '#6366f1', fontSize: 13, fontWeight: '800' },
    ...
    tagText: { color: '#6366f1', fontSize: 13, fontWeight: '700' },
    addTagBtn: { paddingHorizontal: 16, paddingVertical: 8 },
    addTagText: { color: '#6366f1', fontSize: 13, fontWeight: '700' }
});
