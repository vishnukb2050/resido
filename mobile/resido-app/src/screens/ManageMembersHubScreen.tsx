...
const styles = StyleSheet.create({
    ...
    sectionTitle: { fontSize: 13, color: '#94a3b8', fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 10 },
    tile: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.03)', padding: 20, borderRadius: 28, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
    ...
    tileSub: { fontSize: 13, color: '#64748b', marginTop: 4, fontWeight: '600' }
});
