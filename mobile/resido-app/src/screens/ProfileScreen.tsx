        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
                ...
                <View style={styles.infoSection}>
                    ...
                    <ContactCard icon="mail" label="Email" value={user?.email || 'Not provided'} color="#1d4ed8" />
                ...
                <View style={styles.infoSection}>
                    ...
                    <View style={styles.socialGrid}>
                        ...
                        <SocialBubble icon="globe-outline" color="#1d4ed8" label="Website" isPresent={!!user?.website} />
                    </View>
                </View>
            </ScrollView>
...
const styles = StyleSheet.create({
    ...
    heroHeader: { height: 240, backgroundColor: '#1d4ed8', flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20, paddingTop: 60 },
    ...
    mainAvatar: { width: '100%', height: '100%', borderRadius: 55, borderWidth: 4, borderColor: '#1d4ed8' },
    ...
    profileHandle: { fontSize: 14, color: '#1d4ed8', fontWeight: '700', marginTop: 4 },
    ...
    editProfileBtnText: { color: '#1d4ed8', fontWeight: '800', fontSize: 14 },
