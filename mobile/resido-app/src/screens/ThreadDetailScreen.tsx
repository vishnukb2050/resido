            ...
            >
                        ...
                        <View style={styles.threadContent}>
                            <View style={styles.authorSection}>
                                ...
                                <View style={styles.visibilityBadge}>
                                    <Ionicons name="globe-outline" size={12} color="#4c1d95" />
                            ...
                            <View style={styles.statsRow}>
                                ...
                                <TouchableOpacity style={styles.statItem} onPress={() => router.push(`/chat-list?forwardContent=${encodeURIComponent(thread.title + '\n' + thread.content)}`)}>
                                    <Ionicons name="chatbubbles-outline" size={22} color="#4c1d95" />
                                    <Text style={[styles.statText, { color: '#4c1d95' }]}>Forward</Text>
                                </TouchableOpacity>
                            </View>
                ...
                <View style={styles.inputWrapper}>
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        >
                            {sending ? <ActivityIndicator size="small" color="#4c1d95" /> : <Ionicons name="send" size={20} color="#4c1d95" />}
                        </TouchableOpacity>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    visibilityText: { fontSize: 10, fontWeight: '800', color: '#4c1d95', marginLeft: 4, textTransform: 'uppercase' },
    ...
    backBtn: { marginTop: 20, backgroundColor: '#4c1d95', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 12 },
    ...
    pollPercentage: { fontSize: 13, fontWeight: '800', color: '#4c1d95', zIndex: 1 },
    ...
    commentPollOptionSelected: { borderColor: '#4c1d95', backgroundColor: '#f5f3ff' },
    commentPollProgress: { position: 'absolute', left: 0, top: 0, bottom: 0, backgroundColor: '#4c1d9515' },
    commentPollOptionText: { fontSize: 12, fontWeight: '700', color: '#475569', zIndex: 1 },
    commentPollOptionTextSelected: { color: '#4c1d95' },
    commentPollPercentage: { fontSize: 11, fontWeight: '800', color: '#4c1d95', zIndex: 1 },
