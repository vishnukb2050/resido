            ...
            <View style={styles.cardContent}>
                <View style={styles.cardHeader}>
                    <View style={styles.cmcLogoBoxSmall}>
                        <MaterialCommunityIcons name="office-building" size={24} color="#0d9488" />
                    </View>
...
const styles = StyleSheet.create({
    ...
    typeText: { fontSize: 10, fontWeight: '800', color: '#0d9488', textTransform: 'uppercase' },
    cardFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    stat: { flexDirection: 'row', alignItems: 'center', gap: 6 },
    statText: { fontSize: 13, color: '#64748b', fontWeight: '500' },
    joinBtn: { backgroundColor: '#0d9488', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
