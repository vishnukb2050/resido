...
export default function MemberProfileScreen() {
    ...
    if (loading) return <View style={styles.center}><ActivityIndicator size="large" color="#4c1d95" /></View>;
...
const styles = StyleSheet.create({
    ...
    alias: { fontSize: 14, color: '#4c1d95', fontWeight: '700', marginTop: 4 },
    ...
    followBtn: { marginTop: 25, width: '60%', height: 50, borderRadius: 25, backgroundColor: '#4c1d95', alignItems: 'center', justifyContent: 'center', shadowColor: '#4c1d95', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 4 },
