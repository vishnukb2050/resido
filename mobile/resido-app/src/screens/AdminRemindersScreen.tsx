...
const styles = StyleSheet.create({
    ...
    titleText: { color: '#2D2445', fontSize: 20, fontWeight: '900' },
    ...
    metricVal: { fontSize: 22, fontWeight: '900', color: '#2D2445' },
    ...
    tabTextActive: { color: '#2D2445', fontWeight: '900' },
    ...
    selectorTextActive: { color: '#2D2445' },
    ...
    subTitle: { fontSize: 13, fontWeight: '900', color: '#2D2445', marginBottom: 15 },
    ...
    smallTabTextActive: { color: '#2D2445' },
    ...
    checkboxTextActive: { color: '#2D2445', fontWeight: '900' },
    ...
    roleSelectTextActive: { color: '#2D2445', fontWeight: '900' },
    ...
    scheduleTitle: { fontSize: 14, fontWeight: '800', color: '#2D2445' },
    ...
    remTitle: { color: '#2D2445', fontSize: 16, fontWeight: '800' },
    ...
    imagePreviewBtnText: { color: '#2D2445', fontSize: 10, fontWeight: '800' },
