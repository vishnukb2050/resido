...
const COLORS = ['#f59e0b', '#10b981', '#0d9488', '#f97316', '#3b82f6', '#ec4899', '#ef4444'];
...
const styles = StyleSheet.create({
    ...
    saveBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#0d9488', alignItems: 'center', justifyContent: 'center' },
