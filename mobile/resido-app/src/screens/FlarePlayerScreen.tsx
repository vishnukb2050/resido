        ...
        <View style={[styles.flareItem, { height: SCREEN_HEIGHT }]}>
            ...
            <View style={[styles.bottomOverlay, { paddingBottom: insets.bottom + 20 }]}>
                ...
                >
                    ...
                    {flare.isVerified && <MaterialCommunityIcons name="check-decagram" size={18} color="#1d4ed8" style={styles.verified} />}
                </TouchableOpacity>
                                ...
                                return (
                                    <View key={opt.id} style={styles.resultItem}>
                                        ...
                                        <View style={styles.progressBg}>
                                            <View style={[styles.progressFill, { width: `${percentage}%` }, isSelected && { backgroundColor: '#1d4ed8' }]} />
                                        </View>
                                    </View>
                                );
                            }
