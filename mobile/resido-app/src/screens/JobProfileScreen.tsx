...
import { View, Text, StyleSheet, ScrollView, TextInput, TouchableOpacity, Switch, Image, Dimensions, StatusBar } from 'react-native';
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
                            ...
                            {CATEGORY_SUGGESTIONS.map(cat => (
                                ...
                                >
                                    <View style={styles.sugIconBox}>
                                        <MaterialCommunityIcons name={cat.icon as any} size={20} color="#1d4ed8" />
                                    </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.row}>
                        ...
                        <TouchableOpacity style={styles.mediaBtn}>
                            <Ionicons name="videocam-outline" size={24} color="#1d4ed8" />
                            <View style={styles.mediaTextContent}>
...
const styles = StyleSheet.create({
    ...
    header: { padding: 20, paddingTop: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#f1f5f9', backgroundColor: '#fff' },
    ...
    previewBtn: { fontSize: 15, color: '#1d4ed8', fontWeight: '800' },
    content: { flex: 1 },
    ...
    viewAllCatText: { fontSize: 13, color: '#1d4ed8', fontWeight: '800' },
    ...
    radioActive: { borderColor: '#1d4ed8', backgroundColor: '#f5f3ff' },
    ...
    mediaBtnTitle: { fontSize: 13, fontWeight: '800', color: '#1d4ed8' },
