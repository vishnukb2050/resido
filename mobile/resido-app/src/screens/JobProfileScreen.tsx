                            ...
                            {CATEGORY_SUGGESTIONS.map(cat => (
                                ...
                                >
                                    <View style={styles.sugIconBox}>
                                        <MaterialCommunityIcons name={cat.icon as any} size={20} color="#6366f1" />
                                    </View>
...
const styles = StyleSheet.create({
    ...
    viewAllCatText: { fontSize: 13, color: '#6366f1', fontWeight: '800' },
    ...
    radioActive: { borderColor: '#6366f1', backgroundColor: '#f5f3ff' },
    ...
    mediaBtnTitle: { fontSize: 13, fontWeight: '800', color: '#6366f1' },
    ...
    publishBtn: { flex: 1.5, backgroundColor: '#6366f1', padding: 16, borderRadius: 14, alignItems: 'center', shadowColor: '#6366f1', shadowOpacity: 0.25, shadowRadius: 10, elevation: 5 },
