...
const CATEGORIES = [
    { id: 'all', name: 'All', icon: 'apps', color: '#4c1d95' },
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                        ...
                        {selectedLocationName ? (
                            <View style={styles.selectedAreaHeader}>
                                <View style={styles.selectedAreaBadge}>
                                    <Ionicons name="location" size={16} color="#4c1d95" />
                    ...
                    <View style={styles.mapViewContainer}>
                        ...
                        <View style={styles.mapOverlayHeader}>
                            <View style={styles.selectedLocationBadge}>
                                <Ionicons name="location" size={18} color="#4c1d95" />
                        ...
                        <TouchableOpacity style={styles.mapGpsBtn} onPress={handleUseCurrentLocation}>
                            <MaterialCommunityIcons name="crosshairs-gps" size={24} color="#4c1d95" />
                        </TouchableOpacity>
                ...
                <View style={styles.verifiedBanner}>
                    ...
                    <View style={styles.verifiedBadgeContainer}>
                        <MaterialCommunityIcons name="certificate" size={40} color="#4c1d95" />
                    ...
                    {POPULAR_SERVICES.map(item => (
                        <TouchableOpacity key={item.id} style={styles.popularCard}>
                            ...
                            <View style={styles.popularIconOverlay}>
                                <MaterialCommunityIcons name={item.icon as any} size={18} color="#4c1d95" />
                            </View>
                            ...
                            >
                                ...
                                <View style={styles.proInfo}>
                                    <View style={styles.proNameRow}>
                                        ...
                                        {pro.isVerified && <Ionicons name="checkmark-circle" size={16} color="#4c1d95" />}
                                    </View>
                ...
                <View style={styles.postJobCard}>
                    <View style={styles.postJobIcon}>
                        <Ionicons name="pricetag" size={24} color="#4c1d95" />
                    </View>
                ...
                <View style={[styles.dropdownContainer, { top: 180, left: 20, right: 20 }]}>
                    <ScrollView keyboardShouldPersistTaps="handled">
                        {locationResults.slice(0, visibleCount).map((loc, idx) => (
                            ...
                            >
                                <Ionicons name={loc.isNoResult ? "help-circle-outline" : "location-outline"} size={16} color={loc.isNoResult ? "#94a3b8" : "#4c1d95"} />
                        ...
                        {locationResults.length > visibleCount && (
                            ...
                            >
                                <Text style={{ color: '#4c1d95', fontWeight: '700', fontSize: 13 }}>
...
const styles = StyleSheet.create({
    ...
    verifiedIconContainer: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', shadowColor: '#4c1d95', shadowOpacity: 0.1 },
    shieldIcon: { backgroundColor: '#4c1d95', width: 32, height: 32, borderRadius: 16, alignItems: 'center', justifyContent: 'center' },
    verifiedTextContent: { flex: 1, marginLeft: 12 },
    verifiedTitle: { fontSize: 14, fontWeight: '800', color: '#4c1d95' },
    ...
    checkInner: { position: 'absolute', width: 18, height: 18, borderRadius: 9, backgroundColor: '#4c1d95', alignItems: 'center', justifyContent: 'center', top: 11 },
    ...
    priceText: { fontSize: 12, color: '#4c1d95', fontWeight: '800' },
    ...
    postJobTitle: { fontSize: 16, fontWeight: '900', color: '#4c1d95' },
    postJobSubtitle: { fontSize: 12, color: '#64748b', marginTop: 2, lineHeight: 18 },
    postJobBtn: { backgroundColor: '#4c1d95', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12 },
    ...
    nearMeText: { fontSize: 12, fontWeight: '700', color: '#4c1d95', marginLeft: 4 },
    ...
    mapDoneBtn: { position: 'absolute', bottom: 20, left: 20, right: 20, backgroundColor: '#4c1d95', height: 50, borderRadius: 15, alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 10, elevation: 8, zIndex: 100 },
    ...
    radiusBtnActive: { backgroundColor: '#4c1d95' },
